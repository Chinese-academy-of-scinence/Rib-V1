...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='c2_a', help='Experiment root')
...
def main(args):
    ...
    with torch.no_grad():
        ...
        for ct in data_list:
            ...
            seg = seg[choice]
            np.save('./inference_results/point/'+ct,points.astype('int32'))
            ...
            np.save('./inference_results/label/'+ct[:-4],pred_choice.astype('int8'))
        time_cost/=num
        ave_dice/=num
